...
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>Siti Nurlita Romadona</Text>
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>2015150088</Text>    
      </ImageBackground>
    );
  }
}
